...
def get_args_parser():
    ...
    parser.add_argument('--arch', default='swin_tiny', type=str,
        choices=['vit_tiny', 'vit_small', 'vit_base', 'xcit', 'deit_tiny', 'deit_small',"swin_tiny"] \
    ...
    parser.add_argument('--output_dir', default="/home/abe/kuma-ssl/dino/exiSwinT", type=str, help='Path to save logs and checkpoints.')
...
class TrainDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = Image.open(file_path).convert("L").convert("RGB")
...
def train_dino(args):
    ...
    if args.arch in swin.__dict__.keys() and 'swin' in args.arch:
        student = swin.__dict__[args.arch](
            window_size=14,
            return_all_tokens=True, 
        )
        teacher = swin.__dict__[args.arch](
            window_size=14,
            drop_path_rate=0.0,
            return_all_tokens=True,
        )
