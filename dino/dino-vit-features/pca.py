...
# python pca.py --root_dir /home/abe/kuma-ssl/data/all_pngs
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir',default="/home/abe/kuma-ssl/dino/dino-vit-features/sz640_", type=str, help='The root save dir for results.') #
    parser.add_argument('--load_size', default=640, type=int, help='load size of the input image.')
    parser.add_argument('--stride', default=4, type=int, help="""stride of first convolution layer. 
                                                                    small stride -> higher resolution.""")
    parser.add_argument('--model_type', default='dino_vits16', type=str,
    ...
    with torch.no_grad():
        ...
        aimed_df = pd.read_csv("/home/abe/kuma-ssl/data/folds8.csv")
    
        images_paths = []
        for i in aimed_df["label"].unique():
            tmp = aimed_df[aimed_df["label"]==i]
            file_path = list(tmp["file_path"].to_numpy())
            file_path = random.sample(file_path,len(file_path)//700)
