...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vitb16', stride: int = 4, model: nn.Module = None, device: str = 'cuda'):
        """
    ...
    def create_model(model_type: str) -> nn.Module:
        ...
        if 'dino' in model_type:
            ...
            pretrained_weights = "/home/abe/kuma-ssl/dino/exp002/checkpoint.pth"
