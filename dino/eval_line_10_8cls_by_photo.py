...
def eval_linear(args):
    ...
    print(tra_df["patient"].value_counts())
    
    tra_df_10per = np.random.permutation(np.array(tra_df["patient"].unique()))[:tra_df["patient"].nunique()//4]

    tra_df_10per = tra_df[tra_df["patient"].isin(tra_df_10per)]
    
    print(tra_df_10per["label"].value_counts())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default="/home/abe/kuma-ssl/dino/exp002/10per8", help='Path to save logs and checkpoints')
