...
def eval_linear(args):
    ...
    utils.load_pretrained_weights_soup(model, args.pretrained_weights,args.pre_weight2, args.checkpoint_key, args.arch, args.patch_size)
    ...
    ###
    tra_df = tra_df.sample(frac=0.01,random_state=args.splitseed).reset_index(drop=True)
    ###
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='/home/abe/kuma-ssl/dino/exp008/checkpoint0100.pth', type=str, help="Path to pretrained weights to evaluate.")
    ...
    parser.add_argument('--pre_weight2', default='/home/abe/kuma-ssl/ibot/work_dirs/exp000/checkpoint0400.pth', type=str, help="""Path to pretrained 
    ...
    parser.add_argument('--output_dir', default="/home/abe/kuma-ssl/dino/exp008/100e_100per", help='Path to save logs and checkpoints')
    parser.add_argument('--num_labels', default=9, type=int, help='Number of labels for linear classifier')
    parser.add_argument('--evaluate', dest='evaluate', action='store_true', help='evaluate model on validation set')
    parser.add_argument("--splitseed", default=1000, type=int)
    args = parser.parse_args()
    args.output_dir = os.path.join(args.output_dir,str(args.splitseed),str(args.fold))
    if args.output_dir:
