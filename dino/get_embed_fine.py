...
def eval_linear(args):
    ...
    embeds = validate_network_(test_loader, model)

    np.save(os.path.join(args.output_dir,"test_emb.npy"),embeds)
...
@torch.no_grad()
def validate_network_(val_loader, model):
    metric_logger = utils.MetricLogger(delimiter="  ")
    header = 'Test:'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default="/home/abe/kuma-ssl/dino/imnetViTS/1per/2022", help='Path to save logs and checkpoints')
    parser.add_argument('--num_labels', default=9, type=int, help='Number of labels for linear classifier')
    parser.add_argument('--evaluate', dest='evaluate', action='store_true', help='evaluate model on validation set')
    args = parser.parse_args()
    #args.output_dir = os.path.join(args.output_dir,str(args.freeze),str(args.fold))
