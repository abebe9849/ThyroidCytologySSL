...
def eval_linear(args):
    ...
    test_df = pd.read_csv("/home/abe/kuma-ssl/precrop/oof.csv")
    ...
    np.save(os.path.join(args.output_dir,f"oof_precrop_pred_n{n_patch}_fold{args.fold}.npy"),preds)
...
def sliding_window_split(image, window_size=224, stride=112):
    N, _, H, W = image.size()
