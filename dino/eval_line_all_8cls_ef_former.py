...
seed_torch()
from ef_former import efficientformerv2_l_teacher,efficientformerv2_l
...
def eval_linear(args):
    ...
    model = efficientformerv2_l(pretrained=False)#maxvit_rmlp_nano_rw_256
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='efformer', type=str, help='Architecture')
    parser.add_argument('--patch_size', default=16, type=int, help='Patch resolution of the model.')
    parser.add_argument('--pretrained_weights', default='/home/abe/kuma-ssl/dino/exp015/checkpoint.pth', type=str, help="Path to pretrained weights to evaluate.")
    ...
    parser.add_argument('--output_dir', default="/home/abe/kuma-ssl/dino/exp015/1per", help='Path to save logs and checkpoints')
