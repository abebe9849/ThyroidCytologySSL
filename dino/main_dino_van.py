...
def get_args_parser():
    ...
    parser.add_argument('--arch', default='vit_small', type=str,
        choices=['vit_tiny', 'vit_small', 'vit_base', 'xcit', 'deit_tiny', 'deit_small',"van_b1"] \
    ...
    parser.add_argument('--output_dir', default="/home/abe/kuma-ssl/dino/exp011", type=str, help='Path to save logs and checkpoints.')
...
add_df = pd.DataFrame()
add_df["file_path"]=glob.glob("/home/abe/kuma-ssl/mixed_data/*png")
add_df['label']=1
...
def train_dino(args):
    ...
    dataset = TrainDataset(aimed_df, transform=transform)
    ...
    if "van" in args.arch:
        student = van.__dict__[args.arch](drop_path_rate=args.drop_path_rate
        )
        teacher = van.__dict__[args.arch]()
        embed_dim = 512
