    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch % args.val_freq == 0 or epoch == args.epochs - 1:
            ...
            for i in range(9):
                ...
                each =  metrics.auc(recall, precision)/9
                pr_auc_each.append(each)
                pr_auc +=each
            print("pr_auc_each",pr_auc_each)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default="/home/abe/kuma-ssl/dino/exp002/10per9", help='Path to save logs and checkpoints')
