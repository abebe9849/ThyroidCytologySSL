...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='/home/abe/kuma-ssl/mae/output_dir/checkpoint-399.pth',
...
def main(args):
    ...
    folds = pd.read_csv("/home/abe/kuma-ssl/data/folds8.csv")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        scheduler.step()
        test_stats,preds,valid_labels = evaluate(data_loader_val, model, device)
        ...
        if log_writer is not None:
            log_writer.add_scalar('perf/PRAUC', pr_auc, epoch)
